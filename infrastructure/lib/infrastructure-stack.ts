...
export class InfrastructureStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const certificate = new acm.Certificate(this, 'ArticleTrainerRootCert', {
        ...
        const bucket = new s3.Bucket(this, 'ArticleTrainerBucket', {
            bucketName: 'article-trainer-bucket-919713414705-us-east-1',  // Should be unique across all zones and accounts
            versioned: true,
        });

        // Sync the build directory contents with the S3 bucket
        const deployment = new s3deploy.BucketDeployment(this, 'DeployArticleTrainerApplication', {
        ...
        const distribution = new cloudfront.Distribution(this, 'ArticleTrainerDistribution', {
            defaultBehavior: {
        ...
        const aRecord = new route53.ARecord(this, 'ArticleTrainerRecord', {
            zone: hostedZone,
